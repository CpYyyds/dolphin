import{l as j,d as ee,a0 as Se,Y as Be,r as B,V as Pe,a3 as Te,h as p,k as b,X as ke,aj as oe,W as Re,n as g,p as l,$ as U,ak as He,e as re,a1 as Ee,U as je,g as R,b as Ie,f as Oe,t as De,al as Fe,am as Ne,P as _e,a8 as Ke,j as r,ae as H}from"./index.02a17cf1.js";import{i as I}from"./is-browser.e7afaa57.js";import{u as Me,c as J}from"./use-form-item.96cfc8ba.js";import{r as Z,i as Ge,c as Ve}from"./resolve-slot.92499a18.js";const We=j("base-wave",`
 position: absolute;
 left: 0;
 right: 0;
 top: 0;
...
`),qe=ee({name:"BaseWave",props:{clsPrefix:{type:String,required:!0}},setup(e){Se("-base-wave",We,Be(e,"clsPrefix"));const f=B(null),h=B(!1);let u=null;return Pe(()=>{u!==null&&window.clearTimeout(u)}),{active:h,selfRef:f,play(){u!==null&&(window.clearTimeout(u),h.value=!1,u=null),Te(()=>{var v;(v=f.value)===null||v===void 0||v.offsetHeight,h.value=!0,u=window.setTimeout(()=>{h.value=!1,u=null},1e3)})}}},render(){const{clsPrefix:e}=this;return p("div",{ref:"selfRef","aria-hidden":!0,class:[`${e}-base-wave`,this.active&&`${e}-base-wave--active`]})}}),{cubicBezierEaseInOut:C}=ke;function Qe({duration:e=".2s",delay:f=".1s"}={}){return[b("&.fade-in-width-expand-transition-leave-from, &.fade-in-width-expand-transition-enter-to",{opacity:1}),b("&.fade-in-width-expand-transition-leave-to, &.fade-in-width-expand-transition-enter-from",`
 ...
 margin-left ${e} ${C},
 margin-right ${e} ${C};
 `)]}const Ae=I&&"chrome"in window;I&&navigator.userAgent.includes("Firefox");const Xe=I&&navigator.userAgent.includes("Safari")&&!Ae;function $(e){return oe(e,[255,255,255,.16])}function E(e){return oe(e,[0,0,0,.12])}const Ye=Re("n-button-group"),Le=b([j("button",`
 margin: 0;
 ...
 `,[g("active",{zIndex:1,animationName:"button-wave-spread, button-wave-opacity"})]),I&&"MozBoxSizing"in document.createElement("div").style?b("&::moz-focus-inner",{border:0}):null,l("border, state-border",`
 position: absolute;
 left: 0;
 top: 0;
 right: 0;
